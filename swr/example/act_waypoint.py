...
from waypoint_extraction.extract_waypoints import dp_waypoint_selection, greedy_waypoint_selection, SWR_waypoint_selection
...
def main(args):
    ...
    for i in tqdm(range(args.start_idx, args.end_idx + 1)):
        ...
        with h5py.File(dataset_path, "r+") as root:
            ...
            # imu_left = root['/observations/imu_left'][()]
            # imu_right = root['/observations/imu_right'][()]
            # imu_quaternion = np.concatenate([imu_left[:, :4], imu_right[:, :4]], axis=1)
            ...
            # select waypoints
            # waypoints = dp_waypoint_selection( # if it's too slow, use SWR_waypoint_selection
            #     env=None,
            #     actions=qpos,
            #     gt_states=qpos,
            ...
            waypoints = SWR_waypoint_selection(  # SWR
                env=None,
                actions=qpos,
                gt_states=qpos,
                err_threshold=args.err_threshold,
